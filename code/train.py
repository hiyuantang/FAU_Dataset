...
# python train.py --dataset_root D:/Datasets/facegen --resume D:/FAU_models/checkpoint_epoch_init.pth --seed 1 --mode 0
# sampe bash command Mac: 
# python train.py --dataset_root /Volumes/Yuan-T7/Datasets/facegen --resume /Volumes/Yuan-T7/FAU_models/checkpoint_epoch_init.pth --seed 1 --mode 0
...
#parser.add_argument('--test_set', default=['ew1', 'ew2', 'ew3', 'ew4', 'ew5'], type=list, 
#                    help='take in a list of skin color scale')
