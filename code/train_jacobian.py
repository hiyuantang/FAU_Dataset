...
parser.add_argument('--jaco', default=0.1, type=float, 
...
def main():
    ...
    if args.resume is None:
        ...
        ignored_layer_keys = ['fc6.weight', 'fc6.bias', 'fc7.weight', 'fc7.bias', 'fc8.weight', 'fc8.bias']
    ...
    set_parameter_requires_grad(readout, feature_extracting=False)
    num_ftrs = readout.fc8.in_features
    readout.fc8 = nn.Linear(num_ftrs, num_classes).to(device)
    params_to_update = readout.parameters()
    ...
    last_layer = list(readout.children())[-1]
    try:
