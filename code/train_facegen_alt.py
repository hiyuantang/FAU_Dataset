...
# python train_facegen_alt.py --seed 558 --dataset_root D:/Datasets/face_gen_single --resume D:/FAU_models/checkpoint_epoch_init.pth
# python train_facegen_alt.py --seed 1 --dataset_root D:/Datasets/face_gen_single --resume D:/FAU_models/models_r82/checkpoint_epoch49.pth
# sampe bash command Mac: 
# python train_facegen_alt.py --seed 1 --dataset_root /Volumes/Yuan-T7/Datasets/face_gen_single --resume /Volumes/Yuan-T7/FAU_models/models_r82/checkpoint_epoch49.pth
